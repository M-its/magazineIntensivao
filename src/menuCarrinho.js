import { catalogo, savarLocalStorage, lerLocalStorage } from "./utilidades"
...
function abrirCarrinho() {
    botaoCarrinho.classList.add("right-[0px]")
    botaoCarrinho.classList.remove("right-[-360px]")
}

function fecharCarrinho() {
    botaoCarrinho.classList.remove("right-[0px]")
    botaoCarrinho.classList.add("right-[-360px]")
}
...
function desenharProdutoNoCarrinho(idProduto) {
    ...
    const cartaoProdutoCarrinho = `
        <button id="remover-item-${produto.id}" class="absolute top-0 right-2">
            <i
                class="fa-solid fa-circle-xmark text-slate-500 hover:text-slate-800 duration-200"
            ></i>
        </button>
        <img
